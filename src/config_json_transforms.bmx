Function config_json_transforms()
  ...
  json.add_transform( "stringify_weapon", "$renderAboveAllWeapons", json.XJ_CONVERT, "boolean" )
  ...
  json.add_transform( "stringify_weapon", "$textureType", json.XJ_DELETE,, predicate_omit_if_not_specClass_beam )
  ...
  json.add_transform( "stringify_weapon", "$renderAboveAllWeapons", json.XJ_DELETE,, predicate_omit_if_boolean_equals_FALSE )
  ...
  json.add_transform( "stringify_weapon", "$unaffectedByProjectileSpeedBonuses", json.XJ_DELETE,, predicate_omit_if_boolean_equals_FALSE ) '0.95 new
  ' unknow things
